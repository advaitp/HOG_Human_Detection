Now that you have read \mbox{\hyperlink{md_vendor_googletest_googletest_docs_V1_5_Primer}{Primer}} and learned how to write tests using Google Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md837}{}\doxysection{More Assertions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md837}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md838}{}\doxysubsection{Explicit Success and Failure}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md838}
...
$\vert$ {\ttfamily FAIL();} $\vert$ {\ttfamily ADD\+\_\+\+FAILURE();} $\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$

{\ttfamily FAIL$\ast$} generates a fatal failure while {\ttfamily ADD\+\_\+\+FAILURE$\ast$} generates a nonfatal failure. These are useful when control flow, rather than a Boolean expression, deteremines the test\textquotesingle{}s success or failure. For example, you might want to write something like\+:
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md839}{}\doxysubsection{Exception Assertions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md839}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md840}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md840}
...
Google Test gives you three different options to solve this problem\+:\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md841}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md841}
...
{\itshape Availability}\+: Linux, Windows, Mac\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md842}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md842}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+4.\+1.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md843}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md843}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md844}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md844}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md846}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md846}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md847}{}\doxysubsection{Windows HRESULT assertions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md847}
...
{\itshape Availability}\+: Windows.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md848}{}\doxysubsection{Type Assertions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md848}
...
{\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md849}{}\doxysubsection{Assertion Placement}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md849}
...
If you want to test {\ttfamily EXPECT\+\_\+$\ast$()/\+ASSERT\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ Catching Failures}}.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md851}{}\doxysubsection{How to Write a Death Test}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md851}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Cygwin, and Mac (the latter three are supported since v1.\+3.\+0). {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+DEATH\+\_\+\+IF\+\_\+\+SUPPORTED} are new in v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md852}{}\doxysubsection{Regular Expression Syntax}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md852}
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md854}{}\doxysubsection{Death Tests And Threads}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md854}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md855}{}\doxysubsection{Death Test Styles}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md855}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md856}{}\doxysubsection{Caveats}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md856}
The {\itshape statement} argument of {\ttfamily ASSERT\+\_\+\+EXIT()} can be any valid C++ statement except that it can not return from the current function. This means {\itshape statement} should not contain {\ttfamily return} or a macro that might return (e.\+g. {\ttfamily ASSERT\+\_\+\+TRUE()} ). If {\itshape statement} returns before it crashes, Google Test will print an error message, and the test will fail.
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md857}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md857}
\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md858}{}\doxysubsection{Adding Traces to Assertions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md858}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md859}{}\doxysubsection{Propagating Fatal Failures}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md859}
...
{\itshape Availability\+:} Linux, Windows, Mac. Assertions from multiple threads are currently not supported.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md861}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md861}
...
{\itshape Availability\+:} Linux, Windows, Mac. {\ttfamily Has\+Nonfatal\+Failure()} and {\ttfamily Has\+Failure()} are available since version 1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md862}{}\doxysection{Logging Additional Information}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md862}
In your test code, you can call {\ttfamily Record\+Property(\char`\"{}key\char`\"{}, value)} to log additional information, where {\ttfamily value} can be either a C string or a 32-\/bit integer. The {\itshape last} value recorded for a key will be emitted to the XML output if you specify one. For example, the test
...
\item {\ttfamily key} must be a valid XML attribute name, and cannot conflict with the ones already used by Google Test ({\ttfamily name}, {\ttfamily status}, {\ttfamily time}, and {\ttfamily classname}).
\end{DoxyItemize}

{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md863}{}\doxysection{Sharing Resources Between Tests in the Same Test Case}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md863}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md864}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md864}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md865}{}\doxysection{Value Parameterized Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md865}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md866}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md866}
To write value-\/parameterized tests, first you should define a fixture class. It must be derived from {\ttfamily \+::testing\+::\+Test\+With\+Param\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}, where {\ttfamily T} is the type of your parameter values. {\ttfamily Test\+With\+Param\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} is itself derived from {\ttfamily \mbox{\hyperlink{classtesting_1_1Test}{testing\+::\+Test}}}. {\ttfamily T} can be any copyable type. If it\textquotesingle{}s a raw pointer, you are responsible for managing the lifespan of the pointed values.
...
{\itshape Availability}\+: Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+2.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md867}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md867}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily INSTANTIATE\+\_\+\+TEST\+\_\+\+CASE\+\_\+\+P()}, and linking with {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test case multiple times, possibly in different source files.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md868}{}\doxysection{Typed Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md868}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md869}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md869}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md870}{}\doxysection{Testing Private Code}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md870}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md871}{}\doxysubsection{Static Functions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md871}
...
However, a better approach is to move the private code into the {\ttfamily foo\+::internal} namespace, where {\ttfamily foo} is the namespace your project normally uses, and put the private declarations in a {\ttfamily $\ast$-\/internal.h} file. Your production {\ttfamily .cc} files and your tests are allowed to include this internal header, but your clients are not. This way, you can fully test your internal implementation without leaking it to your clients.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md872}{}\doxysubsection{Private Class Members}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md872}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md873}{}\doxysection{Catching Failures}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md873}
...
{\ttfamily \texorpdfstring{$<$}{<}\mbox{\hyperlink{gtest-spi_8h_source}{gtest/gtest-\/spi.\+h}}\texorpdfstring{$>$}{>}} contains some constructs to do this. After {\ttfamily \#include}ing this header, you can use
...
{\itshape Note\+:} Google Test is designed with threads in mind. Once the synchronization primitives in {\ttfamily \texorpdfstring{$<$}{<}\mbox{\hyperlink{gtest-port_8h_source}{gtest/internal/gtest-\/port.\+h}}\texorpdfstring{$>$}{>}} have been implemented, Google Test will become thread-\/safe, meaning that you can then use assertions in multiple threads concurrently. Before
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md874}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md874}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md875}{}\doxysection{Extending Google Test by Handling Test Events}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md875}
...
{\itshape Availability\+:} Linux, Windows, Mac; since v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md876}{}\doxysubsection{Defining Event Listeners}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md876}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md877}{}\doxysubsection{Using Event Listeners}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md877}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default XML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md878}{}\doxysubsection{Generating Failures in Listeners}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md878}
...
We have a sample of failure-\/raising listener \href{../samples/sample10_unittest.cc}{\texttt{ here}}.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md879}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md879}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md880}{}\doxysubsection{Selecting Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md880}
This section shows various options for choosing which tests to run.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md881}{}\doxysubsubsection{Listing Test Names}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md881}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md882}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md882}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md883}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md883}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md884}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md884}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md885}{}\doxysubsection{Repeating the Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md885}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md886}{}\doxysubsection{Shuffling the Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md886}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md887}{}\doxysubsection{Controlling Test Output}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md887}
{\itshape  This section teaches how to tweak the way test results are reported.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md888}{}\doxysubsubsection{Colored Terminal Output}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md888}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md889}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md889}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md890}{}\doxysubsubsection{Generating an XML Report}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md890}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md891}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md891}
{\itshape  }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md892}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md892}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md893}{}\doxysubsubsection{Suppressing Pop-\/ups Caused by Exceptions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md893}
{\itshape  On Windows, Google Test may be used with exceptions enabled. Even when exceptions are disabled, an application can still throw structured exceptions (SEH\textquotesingle{}s). If a test throws an exception, by default Google Test doesn\textquotesingle{}t try to catch it. Instead, you\textquotesingle{}ll see a pop-\/up dialog, at which point you can attach the process to a debugger and easily find out what went wrong.}

{\itshape However, if you don\textquotesingle{}t want to see the pop-\/ups (for example, if you run the tests in a batch job), set the {\ttfamily GTEST\+\_\+\+CATCH\+\_\+\+EXCEPTIONS} environment variable to a non-\/ {\ttfamily 0} value, or use the {\ttfamily -\/-\/gtest\+\_\+catch\+\_\+exceptions} flag. Google Test now catches all test-\/thrown exceptions and logs them as failures.}

{\itshape {\itshape Availability\+:} Windows. {\ttfamily GTEST\+\_\+\+CATCH\+\_\+\+EXCEPTIONS} and {\ttfamily -\/-\/gtest\+\_\+catch\+\_\+exceptions} have no effect on Google Test\textquotesingle{}s behavior on Linux or Mac, even if exceptions are enabled. It is possible to add support for catching exceptions on these platforms, but it is not implemented yet.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md894}{}\doxysubsubsection{Letting Another Testing Framework Drive}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md894}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md895}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md895}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md896}{}\doxysection{Fusing Google Test Source Files}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md896}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md897}{}\doxysection{Where to Go from Here}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md897}
{\itshape  Congratulations! You\textquotesingle{}ve now learned more advanced Google Test tools and are ready to tackle more complex testing tasks. If you want to dive even deeper, you can read the \mbox{\hyperlink{md_vendor_googletest_googletest_docs_V1_5_FAQ}{FAQ}}. }