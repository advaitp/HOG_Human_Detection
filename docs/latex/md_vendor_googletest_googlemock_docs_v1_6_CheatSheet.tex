\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md365}{}\doxysection{Mocking a Normal Class}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md365}
Given 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md366}{}\doxysection{Mocking a Class Template}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md366}
To mock 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md367}{}\doxysection{Specifying Calling Conventions for Mock Functions}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md367}
...
\end{DoxyCode}
 where {\ttfamily STDMETHODCALLTYPE} is defined by {\ttfamily \texorpdfstring{$<$}{<}objbase.\+h\texorpdfstring{$>$}{>}} on Windows.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md368}{}\doxysection{Using Mocks in Tests}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md368}
The typical flow is\+:
\begin{DoxyEnumerate}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md369}{}\doxysection{Setting Default Actions}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md369}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md370}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md370}
...
A method with no {\ttfamily EXPECT\+\_\+\+CALL()} is free to be invoked {\itshape any number of times}, and the default action will be taken each time.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md371}{}\doxysection{Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md371}
...
Built-\/in matchers (where {\ttfamily argument} is the function argument) are divided into several categories\+:\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md372}{}\doxysubsection{Wildcard}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md372}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md373}{}\doxysubsection{Generic Comparison}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md373}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
These matchers use ULP-\/based comparison (the same as used in \href{http://code.google.com/p/googletest/}{\texttt{ Google Test}}). They automatically pick a reasonable error bound based on the absolute value of the expected value. {\ttfamily Double\+Eq()} and {\ttfamily Float\+Eq()} conform to the IEEE standard, which requires comparing two Na\+Ns for equality to return false. The {\ttfamily Nan\+Sensitive$\ast$} version instead treats two Na\+Ns as equal, which is often what a user wants.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md375}{}\doxysubsection{String Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md375}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} use the regular expression syntax defined \href{http://code.google.com/p/googletest/wiki/V1_6_AdvancedGuide\#Regular_Expression_Syntax}{\texttt{ here}}. {\ttfamily Str\+Case\+Eq()}, {\ttfamily Str\+Case\+Ne()}, {\ttfamily Str\+Eq()}, and {\ttfamily Str\+Ne()} work for wide strings as well.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md376}{}\doxysubsection{Container Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md376}
...
where the array may be multi-\/dimensional (i.\+e. its elements can be arrays).\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md377}{}\doxysubsection{Member Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md377}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md378}{}\doxysubsection{Matching the Result of a Function or Functor}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md378}
$\vert${\ttfamily Result\+Of(f, m)}$\vert${\ttfamily f(argument)} matches matcher {\ttfamily m}, where {\ttfamily f} is a function or functor.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md379}{}\doxysubsection{Pointer Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md379}
$\vert${\ttfamily Pointee(m)}$\vert${\ttfamily argument} (either a smart pointer or a raw pointer) points to a value that matches matcher {\ttfamily m}.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md380}{}\doxysubsection{Multiargument Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md380}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md381}{}\doxysubsection{Composite Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md381}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md382}{}\doxysubsection{Adapters for Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md382}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)}   }&\cellcolor{\tableheadbgcolor}\textbf{ casts matcher {\ttfamily m} to type {\ttfamily Matcher\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.    }\\\cline{1-2}
\endhead
{\ttfamily Safe\+Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)}   &\href{http://code.google.com/p/googlemock/wiki/V1_6_CookBook\#Casting_Matchers}{\texttt{ safely casts}} matcher {\ttfamily m} to type {\ttfamily Matcher\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.    \\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md383}{}\doxysubsection{Matchers as Predicates}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md383}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md384}{}\doxysubsection{Defining Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md384}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md385}{}\doxysubsection{Matchers as Test Assertions}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md385}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily ASSERT\+\_\+\+THAT(expression, m)}   }&\cellcolor{\tableheadbgcolor}\textbf{ Generates a \href{http://code.google.com/p/googletest/wiki/V1_6_Primer\#Assertions}{\texttt{ fatal failure}} if the value of {\ttfamily expression} doesn\textquotesingle{}t match matcher {\ttfamily m}.    }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md386}{}\doxysection{Actions}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md386}
{\bfseries{Actions}} specify what a mock function should do when invoked.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md387}{}\doxysubsection{Returning a Value}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md387}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md388}{}\doxysubsection{Side Effects}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md388}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md389}{}\doxysubsection{Using a Function or a Functor as an Action}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md389}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyCode}
 calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md390}{}\doxysubsection{Default Action}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md390}
...
{\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md391}{}\doxysubsection{Composite Actions}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md391}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md392}{}\doxysubsection{Defining Actions}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md392}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
The {\ttfamily ACTION$\ast$} macros cannot be used inside a function or class.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md393}{}\doxysection{Cardinalities}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md393}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md394}{}\doxysection{Expectation Order}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md394}
By default, the expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, there are two ways to specify it. They can be used either independently or together.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md395}{}\doxysubsection{The After Clause}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md395}
...
\end{DoxyCode}
 says that all expected calls in the scope of {\ttfamily dummy} must occur in strict order. The name {\ttfamily dummy} is irrelevant.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md397}{}\doxysection{Verifying and Resetting a Mock}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md397}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md398}{}\doxysection{Mock Classes}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md398}
...
\end{DoxyCode}
 See this \href{http://code.google.com/p/googlemock/wiki/V1_6_CookBook\#Using_Check_Points}{\texttt{ recipe}} for one application of it.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md399}{}\doxysection{Flags}\label{md_vendor_googletest_googlemock_docs_v1_6_CheatSheet_autotoc_md399}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
