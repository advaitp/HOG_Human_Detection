Now that you have read \mbox{\hyperlink{md_vendor_googletest_googletest_docs_V1_7_Primer}{Primer}} and learned how to write tests using Google Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1108}{}\doxysection{More Assertions}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1108}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1109}{}\doxysubsection{Explicit Success and Failure}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1109}
...
$\vert$ {\ttfamily SUCCEED();} $\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$
...
Note\+: {\ttfamily SUCCEED()} is purely documentary and currently doesn\textquotesingle{}t generate any user-\/visible output. However, we may add {\ttfamily SUCCEED()} messages to Google Test\textquotesingle{}s output in the future.

$\vert$ {\ttfamily FAIL();} $\vert$ {\ttfamily ADD\+\_\+\+FAILURE();} $\vert$ {\ttfamily ADD\+\_\+\+FAILURE\+\_\+\+AT(\char`\"{}$<$/tt$>$\+\_\+file\+\_\+path\+\_\+$<$tt$>$\char`\"{},}\+\_\+line\+\_\+number\+\_\+{\ttfamily );} $\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$

{\ttfamily FAIL()} generates a fatal failure, while {\ttfamily ADD\+\_\+\+FAILURE()} and {\ttfamily ADD\+\_\+\+FAILURE\+\_\+\+AT()} generate a nonfatal failure. These are useful when control flow, rather than a Boolean expression, deteremines the test\textquotesingle{}s success or failure. For example, you might want to write something like\+:
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1110}{}\doxysubsection{Exception Assertions}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1110}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1111}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1111}
...
Google Test gives you three different options to solve this problem\+:\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1112}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1112}
...
the assertion {\ttfamily EXPECT\+\_\+\+PRED2(\+Mutually\+Prime, a, b);} will succeed, while the assertion {\ttfamily EXPECT\+\_\+\+PRED2(\+Mutually\+Prime, b, c);} will fail with the message
...
\begin{DoxyEnumerate}
\item If you see a compiler error \char`\"{}no matching function to call\char`\"{} when using {\ttfamily ASSERT\+\_\+\+PRED$\ast$} or {\ttfamily EXPECT\+\_\+\+PRED$\ast$}, please see \href{V1_7_FAQ.md\#the-compiler-complains-about-undefined-references-to-some-static-const-member-variables-but-i-did-define-them-in-the-class-body-whats-wrong}{\texttt{ this}} for how to resolve it.
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
...
{\itshape Availability}\+: Linux, Windows, Mac\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1113}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1113}
While {\ttfamily EXPECT\+\_\+\+PRED$\ast$()} and friends are handy for a quick job, the syntax is not satisfactory\+: you have to use different macros for different arities, and it feels more like Lisp than C++. The {\ttfamily \mbox{\hyperlink{classtesting_1_1AssertionResult}{testing\+::\+Assertion\+Result}}} class solves this problem.
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+4.\+1.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1114}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1114}
...
\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Fatal assertion}}   }&\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Nonfatal assertion}}   }&\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Verifies}}    }\\\cline{1-3}
\endhead
{\ttfamily ASSERT\+\_\+\+PRED\+\_\+\+FORMAT1(}\+\_\+pred\+\_\+format1, val1\+\_\+{\ttfamily );}   &{\ttfamily EXPECT\+\_\+\+PRED\+\_\+\+FORMAT1(}\+\_\+pred\+\_\+format1, val1\+\_\+{\ttfamily ); \textbackslash{}ilinebr \texorpdfstring{$<$}{<}/td\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}td class=\char`\"{}markdown\+Table\+Body\+Left\char`\"{}\texorpdfstring{$>$}{>} \+\_\+pred\textbackslash{}\+\_\+format1(val1)\+\_\+ is successful \textbackslash{}ilinebr \texorpdfstring{$<$}{<}/td\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}/tr\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}tr class=\char`\"{}markdown\+Table\+Row\+Even\char`\"{}\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}td class=\char`\"{}markdown\+Table\+Body\+Left\char`\"{}\texorpdfstring{$>$}{>}}ASSERT\+\_\+\+PRED\+\_\+\+FORMAT2({\ttfamily \+\_\+pred\textbackslash{}\+\_\+format2, val1, val2\+\_\+});{\ttfamily \textbackslash{}ilinebr \texorpdfstring{$<$}{<}/td\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}td class=\char`\"{}markdown\+Table\+Body\+Left\char`\"{}\texorpdfstring{$>$}{>}}EXPECT\+\_\+\+PRED\+\_\+\+FORMAT2({\ttfamily \+\_\+pred\textbackslash{}\+\_\+format2, val1, val2\+\_\+});{\ttfamily \textbackslash{}ilinebr \texorpdfstring{$<$}{<}/td\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}td class=\char`\"{}markdown\+Table\+Body\+Left\char`\"{}\texorpdfstring{$>$}{>} \+\_\+pred\textbackslash{}\+\_\+format2(val1, val2)\+\_\+ is successful \textbackslash{}ilinebr \texorpdfstring{$<$}{<}/td\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}/tr\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}tr class=\char`\"{}markdown\+Table\+Row\+Odd\char`\"{}\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}td class=\char`\"{}markdown\+Table\+Body\+Left\char`\"{}\texorpdfstring{$>$}{>}}...{\ttfamily \textbackslash{}ilinebr \texorpdfstring{$<$}{<}/td\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}td class=\char`\"{}markdown\+Table\+Body\+Left\char`\"{}\texorpdfstring{$>$}{>}}...{\ttfamily \textbackslash{}ilinebr \texorpdfstring{$<$}{<}/td\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}td class=\char`\"{}markdown\+Table\+Body\+Left\char`\"{}\texorpdfstring{$>$}{>}}...\`{}   \\\cline{1-3}
\end{longtabu}


The difference between this and the previous two groups of macros is that instead of a predicate, {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+PRED\+\_\+\+FORMAT$\ast$} take a {\itshape predicate-\/formatter} ({\itshape pred\+\_\+formatn}), which is a function or functor with the signature\+:

{\ttfamily \mbox{\hyperlink{classtesting_1_1AssertionResult}{testing\+::\+Assertion\+Result}} Predicate\+Formattern(const char$\ast$}\+\_\+expr1\+\_\+{\ttfamily , const char$\ast$}\+\_\+expr2\+\_\+{\ttfamily , ... const char$\ast$}\+\_\+exprn\+\_\+{\ttfamily , T1}\+\_\+val1\+\_\+{\ttfamily , T2}\+\_\+val2\+\_\+{\ttfamily , ... Tn}\+\_\+valn\+\_\+{\ttfamily );}
...
A predicate-\/formatter returns a {\ttfamily \mbox{\hyperlink{classtesting_1_1AssertionResult}{testing\+::\+Assertion\+Result}}} object to indicate whether the assertion has succeeded or not. The only way to create such an object is to call one of these factory functions\+:

As an example, let\textquotesingle{}s improve the failure message in the previous example, which uses {\ttfamily EXPECT\+\_\+\+PRED2()}\+:
...
As you may have realized, many of the assertions we introduced earlier are special cases of {\ttfamily (EXPECT$\vert$\+ASSERT)\+\_\+\+PRED\+\_\+\+FORMAT$\ast$}. In fact, most of them are indeed defined using {\ttfamily (EXPECT$\vert$\+ASSERT)\+\_\+\+PRED\+\_\+\+FORMAT$\ast$}.

{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1115}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1115}
...
In general, for floating-\/point comparison to make sense, the user needs to carefully choose the error bound. If they don\textquotesingle{}t want or care to, comparing in terms of Units in the Last Place (ULPs) is a good default, and Google Test provides assertions to do this. Full details about ULPs are quite long; if you want to learn more, see \href{http://www.cygnus-software.com/papers/comparingfloats/comparingfloats.htm}{\texttt{ this article on float comparison}}.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1116}{}\doxysubsubsection{Floating-\/\+Point Macros}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1116}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Fatal assertion}}   }&\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Nonfatal assertion}}   }&\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Verifies}}    }\\\cline{1-3}
...
\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Fatal assertion}}   }&\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Nonfatal assertion}}   }&\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Verifies}}    }\\\cline{1-3}
\endhead
{\ttfamily ASSERT\+\_\+\+FLOAT\+\_\+\+EQ(}\+\_\+expected, actual\+\_\+{\ttfamily );}   &{\ttfamily EXPECT\+\_\+\+FLOAT\+\_\+\+EQ(}\+\_\+expected, actual\+\_\+{\ttfamily );}   &the two {\ttfamily float} values are almost equal    \\\cline{1-3}
{\ttfamily ASSERT\+\_\+\+DOUBLE\+\_\+\+EQ(}\+\_\+expected, actual\+\_\+{\ttfamily );}   &{\ttfamily EXPECT\+\_\+\+DOUBLE\+\_\+\+EQ(}\+\_\+expected, actual\+\_\+{\ttfamily );}   &the two {\ttfamily double} values are almost equal   \\\cline{1-3}
\end{longtabu}


By \char`\"{}almost equal\char`\"{}, we mean the two values are within 4 ULP\textquotesingle{}s from each other.
...
\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Fatal assertion}}   }&\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Nonfatal assertion}}   }&\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Verifies}}    }\\\cline{1-3}
\endhead
{\ttfamily ASSERT\+\_\+\+NEAR(}\+\_\+val1, val2, abs\+\_\+error\+\_\+{\ttfamily );}   &{\ttfamily EXPECT\+\_\+\+NEAR}\+\_\+(val1, val2, abs\+\_\+error\+\_\+$<$tt$>$);   &the difference between {\itshape val1} and {\itshape val2} doesn\textquotesingle{}t exceed the given absolute error   \\\cline{1-3}
\end{longtabu}


{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1117}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1117}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1118}{}\doxysubsection{Windows HRESULT assertions}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1118}
...
{\itshape Availability}\+: Windows.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1119}{}\doxysubsection{Type Assertions}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1119}
...
\end{DoxyCode}
 will {\itshape not} generate a compiler error, as {\ttfamily Foo\texorpdfstring{$<$}{<}bool\texorpdfstring{$>$}{>}::Bar()} is never actually instantiated. Instead, you need\+: 
\begin{DoxyCode}{0}
...
{\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1120}{}\doxysubsection{Assertion Placement}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1120}
You can use assertions in any C++ function. In particular, it doesn\textquotesingle{}t have to be a method of the test fixture class. The one constraint is that assertions that generate a fatal failure ({\ttfamily FAIL$\ast$} and {\ttfamily ASSERT\+\_\+$\ast$}) can only be used in void-\/returning functions. This is a consequence of Google Test not using exceptions. By placing it in a non-\/void function you\textquotesingle{}ll get a confusing compile error like {\ttfamily \char`\"{}error\+: void value not ignored as it ought to be\char`\"{}}.
...
If you have defined both {\ttfamily \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<}} and {\ttfamily Print\+To()}, the latter will be used when Google Test is concerned. This allows you to customize how the value appears in Google Test\textquotesingle{}s output without affecting code that relies on the behavior of its {\ttfamily \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<}} operator.
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1122}{}\doxysection{Death Tests}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1122}
...
If you want to test {\ttfamily EXPECT\+\_\+$\ast$()/\+ASSERT\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ Catching Failures}}.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1123}{}\doxysubsection{How to Write a Death Test}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1123}
...
\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Fatal assertion}}   }&\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Nonfatal assertion}}   }&\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{Verifies}}    }\\\cline{1-3}
\endhead
{\ttfamily ASSERT\+\_\+\+DEATH(}\+\_\+statement, regex\+\_\+{\ttfamily ); \textbackslash{}ilinebr \texorpdfstring{$<$}{<}/td\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}td class=\char`\"{}markdown\+Table\+Body\+Left\char`\"{}\texorpdfstring{$>$}{>}}EXPECT\+\_\+\+DEATH({\ttfamily \+\_\+statement, regex\+\_\+});   &{\itshape statement} crashes with the given error    \\\cline{1-3}
{\ttfamily ASSERT\+\_\+\+DEATH\+\_\+\+IF\+\_\+\+SUPPORTED(}\+\_\+statement, regex\+\_\+{\ttfamily ); \textbackslash{}ilinebr \texorpdfstring{$<$}{<}/td\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}td class=\char`\"{}markdown\+Table\+Body\+Left\char`\"{}\texorpdfstring{$>$}{>}}EXPECT\+\_\+\+DEATH\+\_\+\+IF\+\_\+\+SUPPORTED({\ttfamily \+\_\+statement, regex\+\_\+});   &if death tests are supported, verifies that {\itshape statement} crashes with the given error; otherwise verifies nothing    \\\cline{1-3}
{\ttfamily ASSERT\+\_\+\+EXIT(}\+\_\+statement, predicate, regex\+\_\+{\ttfamily ); \textbackslash{}ilinebr \texorpdfstring{$<$}{<}/td\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}td class=\char`\"{}markdown\+Table\+Body\+Left\char`\"{}\texorpdfstring{$>$}{>}}EXPECT\+\_\+\+EXIT({\ttfamily \+\_\+statement, predicate, regex\+\_\+});   &{\itshape statement} exits with the given error and its exit code matches {\itshape predicate}   \\\cline{1-3}
\end{longtabu}
...
In particular, if {\itshape statement} generates an {\ttfamily ASSERT\+\_\+$\ast$} or {\ttfamily EXPECT\+\_\+$\ast$} failure, it will {\bfseries{not}} cause the death test to fail, as Google Test assertions don\textquotesingle{}t abort the process.
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Cygwin, and Mac (the latter three are supported since v1.\+3.\+0). {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+DEATH\+\_\+\+IF\+\_\+\+SUPPORTED} are new in v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1124}{}\doxysubsection{Regular Expression Syntax}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1124}
On POSIX systems (e.\+g. Linux, Cygwin, and Mac), Google Test uses the \href{http://www.opengroup.org/onlinepubs/009695399/basedefs/xbd_chap09.html\#tag_09_04}{\texttt{ POSIX extended regular expression}} syntax in death tests. To learn about this syntax, you may want to read this \href{http://en.wikipedia.org/wiki/Regular_expression\#POSIX_Extended_Regular_Expressions}{\texttt{ Wikipedia entry}}.
...
To help you determine which capability is available on your system, Google Test defines macro {\ttfamily GTEST\+\_\+\+USES\+\_\+\+POSIX\+\_\+\+RE=1} when it uses POSIX extended regular expressions, or {\ttfamily GTEST\+\_\+\+USES\+\_\+\+SIMPLE\+\_\+\+RE=1} when it uses the simple version. If you want your death tests to work in both cases, you can either {\ttfamily \#if} on these macros or use the more limited syntax only.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1125}{}\doxysubsection{How It Works}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1125}
Under the hood, {\ttfamily ASSERT\+\_\+\+EXIT()} spawns a new process and executes the death test statement in that process. The details of of how precisely that happens depend on the platform and the variable {\ttfamily \+::testing\+::\+GTEST\+\_\+\+FLAG(death\+\_\+test\+\_\+style)} (which is initialized from the command-\/line flag {\ttfamily -\/-\/gtest\+\_\+death\+\_\+test\+\_\+style}).
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1126}{}\doxysubsection{Death Tests And Threads}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1126}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1127}{}\doxysubsection{Death Test Styles}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1127}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1128}{}\doxysubsection{Caveats}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1128}
The {\itshape statement} argument of {\ttfamily ASSERT\+\_\+\+EXIT()} can be any valid C++ statement. If it leaves the current function via a {\ttfamily return} statement or by throwing an exception, the death test is considered to have failed. Some Google Test macros may return from the current function (e.\+g. {\ttfamily ASSERT\+\_\+\+TRUE()}), so be sure to avoid them in {\itshape statement}.
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1129}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1129}
\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1130}{}\doxysubsection{Adding Traces to Assertions}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1130}
...
$\vert$ {\ttfamily SCOPED\+\_\+\+TRACE(}\+\_\+message\+\_\+{\ttfamily );} $\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1131}{}\doxysubsection{Propagating Fatal Failures}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1131}
...
Since we don\textquotesingle{}t use exceptions, it is technically impossible to implement the intended behavior here. To alleviate this, Google Test provides two solutions. You could use either the {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+NO\+\_\+\+FATAL\+\_\+\+FAILURE} assertions or the {\ttfamily Has\+Fatal\+Failure()} function. They are described in the following two subsections.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1132}{}\doxysubsubsection{Asserting on Subroutines}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1132}
...
{\itshape Availability\+:} Linux, Windows, Mac. Assertions from multiple threads are currently not supported.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1133}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1133}
...
{\itshape Availability\+:} Linux, Windows, Mac. {\ttfamily Has\+Nonfatal\+Failure()} and {\ttfamily Has\+Failure()} are available since version 1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1134}{}\doxysection{Logging Additional Information}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1134}
In your test code, you can call {\ttfamily Record\+Property(\char`\"{}key\char`\"{}, value)} to log additional information, where {\ttfamily value} can be either a string or an {\ttfamily int}. The {\itshape last} value recorded for a key will be emitted to the XML output if you specify one. For example, the test
...
\item {\ttfamily key} must be a valid XML attribute name, and cannot conflict with the ones already used by Google Test ({\ttfamily name}, {\ttfamily status}, {\ttfamily time}, {\ttfamily classname}, {\ttfamily type\+\_\+param}, and {\ttfamily value\+\_\+param}).
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1135}{}\doxysection{Sharing Resources Between Tests in the Same Test Case}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1135}
...
\begin{DoxyEnumerate}
\item In your test fixture class (say {\ttfamily \mbox{\hyperlink{classFooTest}{Foo\+Test}}} ), define as {\ttfamily static} some member variables to hold the shared resources.
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1136}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1136}
...
Now, when {\ttfamily RUN\+\_\+\+ALL\+\_\+\+TESTS()} is called, it first calls the {\ttfamily Set\+Up()} method of the environment object, then runs the tests if there was no fatal failures, and finally calls {\ttfamily Tear\+Down()} of the environment object.
...
However, we strongly recommend you to write your own {\ttfamily \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}}} and call {\ttfamily Add\+Global\+Test\+Environment()} there, as relying on initialization of global variables makes the code harder to read and may cause problems when you register multiple environments from different translation units and the environments have dependencies among them (remember that the compiler doesn\textquotesingle{}t guarantee the order in which global variables from different translation units are initialized).

{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1137}{}\doxysection{Value Parameterized Tests}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1137}
...
But this setup has serious drawbacks. First, when a test assertion fails in your tests, it becomes unclear what value of the parameter caused it to fail. You can stream a clarifying message into your {\ttfamily EXPECT}/{\ttfamily ASSERT} statements, but it you\textquotesingle{}ll have to do it with all of them. Second, you have to add one such helper function per test. What if you have ten tests? Twenty? A hundred?
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1138}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1138}
To write value-\/parameterized tests, first you should define a fixture class. It must be derived from both {\ttfamily \mbox{\hyperlink{classtesting_1_1Test}{testing\+::\+Test}}} and {\ttfamily \+::testing\+::\+With\+Param\+Interface\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} (the latter is a pure interface), where {\ttfamily T} is the type of your parameter values. For convenience, you can just derive the fixture class from {\ttfamily \+::testing\+::\+Test\+With\+Param\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}, which itself is derived from both {\ttfamily \mbox{\hyperlink{classtesting_1_1Test}{testing\+::\+Test}}} and {\ttfamily \+::testing\+::\+With\+Param\+Interface\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}. {\ttfamily T} can be any copyable type. If it\textquotesingle{}s a raw pointer, you are responsible for managing the lifespan of the pointed values.
...
Finally, you can use {\ttfamily INSTANTIATE\+\_\+\+TEST\+\_\+\+CASE\+\_\+P} to instantiate the test case with any set of parameters you want. Google Test defines a number of functions for generating test parameters. They return what we call (surprise!) {\itshape parameter generators}. Here is a summary of them, which are all in the {\ttfamily testing} namespace\+:
...
{\ttfamily Combine(g1, g2, ..., g\+N)}   &Yields all combinations (the Cartesian product for the math savvy) of the values generated by the {\ttfamily N} generators. This is only available if your system provides the {\ttfamily \texorpdfstring{$<$}{<}tr1/tuple\texorpdfstring{$>$}{>}} header. If you are sure your system does, and Google Test disagrees, you can override it by defining {\ttfamily GTEST\+\_\+\+HAS\+\_\+\+TR1\+\_\+\+TUPLE=1}. See comments in \href{../include/gtest/internal/gtest-port.h}{\texttt{ include/gtest/internal/gtest-\/port.\+h}} for more information.   \\\cline{1-2}
\end{longtabu}
...
{\itshape Availability}\+: Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+2.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1139}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1139}
In the above, we define and instantiate {\ttfamily \mbox{\hyperlink{classFooTest}{Foo\+Test}}} in the same source file. Sometimes you may want to define value-\/parameterized tests in a library and let other people instantiate them later. This pattern is known as {\itshape abstract tests}. As an example of its application, when you are designing an interface you can write a standard suite of abstract tests (perhaps using a factory function as the test parameter) that all implementations of the interface are expected to pass. When someone implements the interface, he can instantiate your suite to get all the interface-\/conformance tests for free.
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily INSTANTIATE\+\_\+\+TEST\+\_\+\+CASE\+\_\+\+P()}, and linking with {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test case multiple times, possibly in different source files.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1140}{}\doxysection{Typed Tests}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1140}
...
Then, use {\ttfamily TYPED\+\_\+\+TEST()} instead of {\ttfamily TEST\+\_\+\+F()} to define a typed test for this test case. You can repeat this as many times as you want\+:
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1141}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1141}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1142}{}\doxysection{Testing Private Code}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1142}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1143}{}\doxysubsection{Static Functions}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1143}
...
However, a better approach is to move the private code into the {\ttfamily foo\+::internal} namespace, where {\ttfamily foo} is the namespace your project normally uses, and put the private declarations in a {\ttfamily $\ast$-\/internal.h} file. Your production {\ttfamily .cc} files and your tests are allowed to include this internal header, but your clients are not. This way, you can fully test your internal implementation without leaking it to your clients.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1144}{}\doxysubsection{Private Class Members}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1144}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1145}{}\doxysection{Catching Failures}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1145}
...
$\vert$ {\ttfamily EXPECT\+\_\+\+FATAL\+\_\+\+FAILURE(}\+\_\+statement, substring\+\_\+{\ttfamily );} $\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$

to assert that {\itshape statement} generates a fatal (e.\+g. {\ttfamily ASSERT\+\_\+$\ast$}) failure whose message contains the given {\itshape substring}, or use

$\vert$ {\ttfamily EXPECT\+\_\+\+NONFATAL\+\_\+\+FAILURE(}\+\_\+statement, substring\+\_\+{\ttfamily );} $\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$
...
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
\item {\itshape statement} in {\ttfamily EXPECT\+\_\+\+FATAL\+\_\+\+FAILURE()} cannot reference local non-\/static variables or non-\/static members of {\ttfamily this} object.
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
\item {\itshape statement} in {\ttfamily EXPECT\+\_\+\+FATAL\+\_\+\+FAILURE()} cannot return a value.
\end{DoxyEnumerate}
...
that, however, Google Test only supports single-\/threaded usage. Once thread-\/safe, {\ttfamily EXPECT\+\_\+\+FATAL\+\_\+\+FAILURE()} and {\ttfamily EXPECT\+\_\+\+NONFATAL\+\_\+\+FAILURE()} will capture failures in the current thread only. If {\itshape statement} creates new threads, failures in these threads will be ignored. If you want to capture failures from all threads instead, you should use the following macros\+:
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1146}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1146}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1147}{}\doxysection{Extending Google Test by Handling Test Events}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1147}
...
{\itshape Availability\+:} Linux, Windows, Mac; since v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1148}{}\doxysubsection{Defining Event Listeners}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1148}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1149}{}\doxysubsection{Using Event Listeners}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1149}
...
\begin{DoxyItemize}
\item note the \char`\"{}s\char`\"{} at the end of the name) in your {\ttfamily \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}}} function, before calling {\ttfamily RUN\+\_\+\+ALL\+\_\+\+TESTS()}\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{int main(int argc, char** argv) \{}
\DoxyCodeLine{  ::testing::InitGoogleTest(\&argc, argv);}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default XML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1150}{}\doxysubsection{Generating Failures in Listeners}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1150}
...
We have a sample of failure-\/raising listener \href{../samples/sample10_unittest.cc}{\texttt{ here}}.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1151}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1151}
...
If an option is specified both by an environment variable and by a flag, the latter takes precedence. Most of the options can also be set/read in code\+: to access the value of command line flag {\ttfamily -\/-\/gtest\+\_\+foo}, write {\ttfamily \+::testing\+::\+GTEST\+\_\+\+FLAG(foo)}. A common pattern is to set the value of a flag before calling {\ttfamily \+::testing\+::\+Init\+Google\+Test()} to change the default value of the flag\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{int main(int argc, char** argv) \{}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1152}{}\doxysubsection{Selecting Tests}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1152}
This section shows various options for choosing which tests to run.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1153}{}\doxysubsubsection{Listing Test Names}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1153}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1154}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1154}
...
\item \`{}./foo\+\_\+test --gtest\+\_\+filter={\ttfamily Also runs everything, due to the single match-\/everything}$\ast${\ttfamily value. $\ast$}./foo\+\_\+test --gtest\+\_\+filter=\mbox{\hyperlink{classFooTest}{Foo\+Test}}.$\ast${\ttfamily Runs everything in test case}\mbox{\hyperlink{classFooTest}{Foo\+Test}}{\ttfamily . $\ast$}./foo\+\_\+test --gtest\+\_\+filter=$\ast$\+Null$\ast$\+:{\itshape Constructor}{\ttfamily Runs any test whose full name contains either}\char`\"{}\+Null\char`\"{}{\ttfamily or}\char`\"{}\+Constructor\char`\"{}{\ttfamily . $\ast$}./foo\+\_\+test --gtest\+\_\+filter=-\/$\ast$\+Death\+Test.$\ast${\ttfamily Runs all non-\/death tests. $\ast$}./foo\+\_\+test --gtest\+\_\+filter=\mbox{\hyperlink{classFooTest}{Foo\+Test}}.$\ast$-\/\+Foo\+Test.Bar{\ttfamily Runs everything in test case}\mbox{\hyperlink{classFooTest}{Foo\+Test}}{\ttfamily except}Foo\+Test.\+Bar\`{}.
\end{DoxyItemize}}

{\itshape {\itshape Availability\+:} Linux, Windows, Mac.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1155}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1155}
...
{\itshape If you need to disable all tests in a test case, you can either add {\ttfamily DISABLED\+\_\+} to the front of the name of each test, or alternatively add it to the front of the test case name.}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1156}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1156}
{\itshape  To include \href{\#temporarily-disabling-tests}{\texttt{ disabled tests}} in test execution, just invoke the test program with the {\ttfamily -\/-\/gtest\+\_\+also\+\_\+run\+\_\+disabled\+\_\+tests} flag or set the {\ttfamily GTEST\+\_\+\+ALSO\+\_\+\+RUN\+\_\+\+DISABLED\+\_\+\+TESTS} environment variable to a value other than {\ttfamily 0}. You can combine this with the \href{\#running-a-subset-of-the-tests}{\texttt{ --gtest\+\_\+filter}} flag to further select which disabled tests to run.}

{\itshape {\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1157}{}\doxysubsection{Repeating the Tests}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1157}
...
{\itshape If your test program contains global set-\/up/tear-\/down code registered using {\ttfamily Add\+Global\+Test\+Environment()}, it will be repeated in each iteration as well, as the flakiness may be in it. You can also specify the repeat count by setting the {\ttfamily GTEST\+\_\+\+REPEAT} environment variable.}

{\itshape {\itshape Availability\+:} Linux, Windows, Mac.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1158}{}\doxysubsection{Shuffling the Tests}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1158}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1159}{}\doxysubsection{Controlling Test Output}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1159}
{\itshape  This section teaches how to tweak the way test results are reported.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1160}{}\doxysubsubsection{Colored Terminal Output}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1160}
...
{\itshape You can set the GTEST\+\_\+\+COLOR environment variable or set the {\ttfamily -\/-\/gtest\+\_\+color} command line flag to {\ttfamily yes}, {\ttfamily no}, or {\ttfamily auto} (the default) to enable colors, disable colors, or let Google Test decide. When the value is {\ttfamily auto}, Google Test will use colors if and only if the output goes to a terminal and (on non-\/\+Windows platforms) the {\ttfamily TERM} environment variable is set to {\ttfamily xterm} or {\ttfamily xterm-\/color}.}

{\itshape {\itshape Availability\+:} Linux, Windows, Mac.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1161}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1161}
{\itshape  By default, Google Test prints the time it takes to run each test. To suppress that, run the test program with the {\ttfamily -\/-\/gtest\+\_\+print\+\_\+time=0} command line flag. Setting the {\ttfamily GTEST\+\_\+\+PRINT\+\_\+\+TIME} environment variable to {\ttfamily 0} has the same effect.}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1162}{}\doxysubsubsection{Generating an XML Report}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1162}
...
{\itshape 
\begin{DoxyItemize}
\item The root {\ttfamily \texorpdfstring{$<$}{<}testsuites\texorpdfstring{$>$}{>}} element corresponds to the entire test program.
\item {\ttfamily \texorpdfstring{$<$}{<}testsuite\texorpdfstring{$>$}{>}} elements correspond to Google Test test cases.
\item {\ttfamily \texorpdfstring{$<$}{<}testcase\texorpdfstring{$>$}{>}} elements correspond to Google Test test functions.
\end{DoxyItemize}}
...
{\itshape 
\begin{DoxyItemize}
\item The {\ttfamily tests} attribute of a {\ttfamily \texorpdfstring{$<$}{<}testsuites\texorpdfstring{$>$}{>}} or {\ttfamily \texorpdfstring{$<$}{<}testsuite\texorpdfstring{$>$}{>}} element tells how many test functions the Google Test program or test case contains, while the {\ttfamily failures} attribute tells how many of them failed.
\item The {\ttfamily time} attribute expresses the duration of the test, test case, or entire test program in milliseconds.
\item Each {\ttfamily \texorpdfstring{$<$}{<}failure\texorpdfstring{$>$}{>}} element corresponds to a single failed Google Test assertion.
\item Some JUnit concepts don\textquotesingle{}t apply to Google Test, yet we have to conform to the DTD. Therefore you\textquotesingle{}ll see some dummy elements and attributes in the report. You can safely ignore these parts.
\end{DoxyItemize}}

{\itshape {\itshape Availability\+:} Linux, Windows, Mac.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1163}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1163}
{\itshape  }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1164}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1164}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1165}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1165}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1166}{}\doxysubsubsection{Letting Another Testing Framework Drive}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1166}
...
{\itshape If you don\textquotesingle{}t write {\ttfamily \+::testing\+::\+GTEST\+\_\+\+FLAG(throw\+\_\+on\+\_\+failure) = true;} in your {\ttfamily \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}}}, you can alternatively enable this feature by specifying the {\ttfamily -\/-\/gtest\+\_\+throw\+\_\+on\+\_\+failure} flag on the command-\/line or setting the {\ttfamily GTEST\+\_\+\+THROW\+\_\+\+ON\+\_\+\+FAILURE} environment variable to a non-\/zero value.}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1167}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1167}
...
\end{DoxyCode}
 and you have 3 machines at your disposal. To run the test functions in parallel, you would set {\ttfamily GTEST\+\_\+\+TOTAL\+\_\+\+SHARDS} to 3 on all machines, and set {\ttfamily GTEST\+\_\+\+SHARD\+\_\+\+INDEX} to 0, 1, and 2 on the machines respectively. Then you would run the same {\ttfamily foo\+\_\+test} on each machine.}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1168}{}\doxysection{Fusing Google Test Source Files}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1168}
...
{\itshape and you should see an {\ttfamily OUTPUT\+\_\+\+DIR} directory being created with files {\ttfamily \mbox{\hyperlink{gtest_8h_source}{gtest/gtest.\+h}}} and {\ttfamily gtest/gtest-\/all.\+cc} in it. These files contain everything you need to use Google Test. Just copy them to anywhere you want and you are ready to write tests. You can use the \href{../scripts/test/Makefile}{\texttt{ scripts/test/\+Makefile}} file as an example on how to compile your tests against them.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1169}{}\doxysection{Where to Go from Here}\label{md_vendor_googletest_googletest_docs_V1_7_AdvancedGuide_autotoc_md1169}
{\itshape  Congratulations! You\textquotesingle{}ve now learned more advanced Google Test tools and are ready to tackle more complex testing tasks. If you want to dive even deeper, you can read the \mbox{\hyperlink{md_vendor_googletest_googletest_docs_V1_7_FAQ}{Frequently-\/\+Asked Questions}}. }