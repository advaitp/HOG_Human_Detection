\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md219}{}\doxysection{Mocking a Normal Class}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md219}
Given 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md220}{}\doxysection{Mocking a Class Template}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md220}
To mock 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md221}{}\doxysection{Specifying Calling Conventions for Mock Functions}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md221}
...
\end{DoxyCode}
 where {\ttfamily STDMETHODCALLTYPE} is defined by {\ttfamily \texorpdfstring{$<$}{<}objbase.\+h\texorpdfstring{$>$}{>}} on Windows.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md222}{}\doxysection{Using Mocks in Tests}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md222}
The typical flow is\+:
\begin{DoxyEnumerate}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md223}{}\doxysection{Setting Default Actions}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md223}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md224}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md224}
...
A method with no {\ttfamily EXPECT\+\_\+\+CALL()} is free to be invoked {\itshape any number of times}, and the default action will be taken each time.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md225}{}\doxysection{Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md225}
...
Built-\/in matchers (where {\ttfamily argument} is the function argument) are divided into several categories\+:\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md226}{}\doxysubsection{Wildcard}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md226}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md227}{}\doxysubsection{Generic Comparison}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md227}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
The above matchers use ULP-\/based comparison (the same as used in \href{http://code.google.com/p/googletest/}{\texttt{ Google Test}}). They automatically pick a reasonable error bound based on the absolute value of the expected value. {\ttfamily Double\+Eq()} and {\ttfamily Float\+Eq()} conform to the IEEE standard, which requires comparing two Na\+Ns for equality to return false. The {\ttfamily Nan\+Sensitive$\ast$} version instead treats two Na\+Ns as equal, which is often what a user wants.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md229}{}\doxysubsection{String Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md229}
...
{\ttfamily Str\+Case\+Eq()}, {\ttfamily Str\+Case\+Ne()}, {\ttfamily Str\+Eq()}, and {\ttfamily Str\+Ne()} work for wide strings as well.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md230}{}\doxysubsection{Container Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md230}
...
where the array may be multi-\/dimensional (i.\+e. its elements can be arrays).\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md231}{}\doxysubsection{Member Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md231}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md232}{}\doxysubsection{Matching the Result of a Function or Functor}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md232}
$\vert${\ttfamily Result\+Of(f, m)}$\vert${\ttfamily f(argument)} matches matcher {\ttfamily m}, where {\ttfamily f} is a function or functor.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md233}{}\doxysubsection{Pointer Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md233}
$\vert${\ttfamily Pointee(m)}$\vert${\ttfamily argument} (either a smart pointer or a raw pointer) points to a value that matches matcher {\ttfamily m}.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md234}{}\doxysubsection{Multiargument Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md234}
...
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily All\+Args(m)}   }&\cellcolor{\tableheadbgcolor}\textbf{ Equivalent to {\ttfamily m}. Useful as syntactic sugar in {\ttfamily .With(\+All\+Args(m))}.    }\\\cline{1-2}
\endhead
{\ttfamily Args\texorpdfstring{$<$}{<}N1, N2, ..., Nk\texorpdfstring{$>$}{>}(m)}   &The {\ttfamily k} selected (using 0-\/based indices) arguments match {\ttfamily m}, e.\+g. {\ttfamily Args\texorpdfstring{$<$}{<}1, 2\texorpdfstring{$>$}{>}(Contains(5))}.   \\\cline{1-2}
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md235}{}\doxysubsection{Composite Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md235}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md236}{}\doxysubsection{Adapters for Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md236}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)}   }&\cellcolor{\tableheadbgcolor}\textbf{ casts matcher {\ttfamily m} to type {\ttfamily Matcher\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.    }\\\cline{1-2}
\endhead
{\ttfamily Safe\+Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)}   &safely casts matcher {\ttfamily m} to type {\ttfamily Matcher\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.    \\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md237}{}\doxysubsection{Matchers as Predicates}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md237}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md238}{}\doxysubsection{Defining Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md238}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
{\ttfamily MATCHER\+\_\+\+P2(Is\+Between, a, b, \char`\"{}is between \%(a)s and \%(b)s\char`\"{}) \{ return a \texorpdfstring{$<$}{<}= arg \&\& arg \texorpdfstring{$<$}{<}= b; \}}   &Defines a matcher {\ttfamily Is\+Between(a, b)} to match a value in the range \mbox{[}{\ttfamily a}, {\ttfamily b}\mbox{]}.   \\\cline{1-2}
\end{longtabu}
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md239}{}\doxysubsection{Matchers as Test Assertions}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md239}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily ASSERT\+\_\+\+THAT(expression, m)}   }&\cellcolor{\tableheadbgcolor}\textbf{ Generates a \href{http://code.google.com/p/googletest/wiki/GoogleTestPrimer\#Assertions}{\texttt{ fatal failure}} if the value of {\ttfamily expression} doesn\textquotesingle{}t match matcher {\ttfamily m}.    }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md240}{}\doxysection{Actions}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md240}
{\bfseries{Actions}} specify what a mock function should do when invoked.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md241}{}\doxysubsection{Returning a Value}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md241}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md242}{}\doxysubsection{Side Effects}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md242}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
{\ttfamily Set\+Argument\+Pointee\texorpdfstring{$<$}{<}N\texorpdfstring{$>$}{>}(value)}   &Assign {\ttfamily value} to the variable pointed by the {\ttfamily N}-\/th (0-\/based) argument.    \\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md243}{}\doxysubsection{Using a Function or a Functor as an Action}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md243}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyCode}
 calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md244}{}\doxysubsection{Default Action}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md244}
...
{\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md245}{}\doxysubsection{Composite Actions}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md245}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md246}{}\doxysubsection{Defining Actions}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md246}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
The {\ttfamily ACTION$\ast$} macros cannot be used inside a function or class.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md247}{}\doxysection{Cardinalities}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md247}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md248}{}\doxysection{Expectation Order}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md248}
By default, the expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, there are two ways to specify it. They can be used either independently or together.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md249}{}\doxysubsection{The After Clause}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md249}
...
Modifying an {\ttfamily Expectation\+Set} after using it in an {\ttfamily .After()} doesn\textquotesingle{}t affect the meaning of the {\ttfamily .After()}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md250}{}\doxysubsection{Sequences}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md250}
...
\end{DoxyCode}
 says that all expected calls in the scope of {\ttfamily dummy} must occur in strict order. The name {\ttfamily dummy} is irrelevant.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md251}{}\doxysection{Verifying and Resetting a Mock}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md251}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md252}{}\doxysection{Mock Classes}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md252}
...
\end{DoxyCode}
 See this recipe for one application of it.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md253}{}\doxysection{Flags}\label{md_vendor_googletest_googlemock_docs_v1_5_CheatSheet_autotoc_md253}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
