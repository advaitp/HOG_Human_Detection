\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md35}{}\doxysection{Mocking a Normal Class}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md35}
Given 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md36}{}\doxysection{Mocking a Class Template}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md36}
To mock 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
 (note that {\ttfamily $\sim$\+Stack\+Interface()} {\bfseries{must}} be virtual) just append {\ttfamily \+\_\+T} to the {\ttfamily MOCK\+\_\+$\ast$} macros\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{template <typename Elem>}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md37}{}\doxysection{Specifying Calling Conventions for Mock Functions}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md37}
If your mock function doesn\textquotesingle{}t use the default calling convention, you can specify it by appending {\ttfamily \+\_\+\+WITH\+\_\+\+CALLTYPE} to any of the macros described in the previous two sections and supplying the calling convention as the first argument to the macro. For example, 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
 where {\ttfamily STDMETHODCALLTYPE} is defined by {\ttfamily \texorpdfstring{$<$}{<}objbase.\+h\texorpdfstring{$>$}{>}} on Windows.\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md38}{}\doxysection{Using Mocks in Tests}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md38}
The typical flow is\+:
\begin{DoxyEnumerate}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md39}{}\doxysection{Setting Default Actions}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md39}
...
To customize the default action for a particular method, use {\ttfamily ON\+\_\+\+CALL()}\+: 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md40}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md40}
...
\item {\ttfamily Times(n)} when there are {\ttfamily n Will\+Once()}s but no {\ttfamily Will\+Repeatedly()}, where {\ttfamily n} \texorpdfstring{$>$}{>}= 1; or
\item {\ttfamily Times(\+At\+Least(n))} when there are {\ttfamily n Will\+Once()}s and a {\ttfamily Will\+Repeatedly()}, where {\ttfamily n} \texorpdfstring{$>$}{>}= 0.
\end{DoxyItemize}

A method with no {\ttfamily EXPECT\+\_\+\+CALL()} is free to be invoked {\itshape any number of times}, and the default action will be taken each time.\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md41}{}\doxysection{Matchers}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md41}
A {\bfseries{matcher}} matches a {\itshape single} argument. You can use it inside {\ttfamily ON\+\_\+\+CALL()} or {\ttfamily EXPECT\+\_\+\+CALL()}, or use it to validate a value directly\+:

\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily EXPECT\+\_\+\+THAT(value, matcher)}   }&\cellcolor{\tableheadbgcolor}\textbf{ Asserts that {\ttfamily value} matches {\ttfamily matcher}.    }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily EXPECT\+\_\+\+THAT(value, matcher)}   }&\cellcolor{\tableheadbgcolor}\textbf{ Asserts that {\ttfamily value} matches {\ttfamily matcher}.    }\\\cline{1-2}
\endhead
{\ttfamily ASSERT\+\_\+\+THAT(value, matcher)}   &The same as {\ttfamily EXPECT\+\_\+\+THAT(value, matcher)}, except that it generates a {\bfseries{fatal}} failure.   \\\cline{1-2}
\end{longtabu}


Built-\/in matchers (where {\ttfamily argument} is the function argument) are divided into several categories\+:\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md42}{}\doxysubsection{Wildcard}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md42}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md43}{}\doxysubsection{Generic Comparison}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md43}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily Double\+Near(a\+\_\+double, max\+\_\+abs\+\_\+error)}   }&\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily argument} is a {\ttfamily double} value close to {\ttfamily a\+\_\+double} (absolute error \texorpdfstring{$<$}{<}= {\ttfamily max\+\_\+abs\+\_\+error}), treating two Na\+Ns as unequal.    }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md45}{}\doxysubsection{String Matchers}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md45}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} use the regular expression syntax defined \href{../../googletest/docs/AdvancedGuide.md\#regular-expression-syntax}{\texttt{ here}}. {\ttfamily Str\+Case\+Eq()}, {\ttfamily Str\+Case\+Ne()}, {\ttfamily Str\+Eq()}, and {\ttfamily Str\+Ne()} work for wide strings as well.\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md46}{}\doxysubsection{Container Matchers}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md46}
...
{\ttfamily Elements\+Are\+Array(\{ e0, e1, ..., en \})}, {\ttfamily Elements\+Are\+Array(array)}, or {\ttfamily Elements\+Are\+Array(array, count)}   &The same as {\ttfamily Elements\+Are()} except that the expected element values/matchers come from an initializer list, STL-\/style container, or C-\/style array.    \\\cline{1-2}
...
{\ttfamily Unordered\+Elements\+Are\+Array(\{ e0, e1, ..., en \})}, {\ttfamily Unordered\+Elements\+Are\+Array(array)}, or {\ttfamily Unordered\+Elements\+Are\+Array(array, count)}   &The same as {\ttfamily Unordered\+Elements\+Are()} except that the expected element values/matchers come from an initializer list, STL-\/style container, or C-\/style array.    \\\cline{1-2}
{\ttfamily When\+Sorted(m)}   &When {\ttfamily argument} is sorted using the {\ttfamily \texorpdfstring{$<$}{<}} operator, it matches container matcher {\ttfamily m}. E.\+g. {\ttfamily When\+Sorted(\+Unordered\+Elements\+Are(1, 2, 3))} verifies that {\ttfamily argument} contains elements {\ttfamily 1}, {\ttfamily 2}, and {\ttfamily 3}, ignoring order.    \\\cline{1-2}
{\ttfamily When\+Sorted\+By(comparator, m)}   &The same as {\ttfamily When\+Sorted(m)}, except that the given comparator instead of {\ttfamily \texorpdfstring{$<$}{<}} is used to sort {\ttfamily argument}. E.\+g. {\ttfamily When\+Sorted\+By(std\+::greater\texorpdfstring{$<$}{<}int\texorpdfstring{$>$}{>}(), Elements\+Are(3, 2, 1))}.   \\\cline{1-2}
\end{longtabu}
...
\item {\ttfamily m} in {\ttfamily Pointwise(m, ...)} should be a matcher for {\ttfamily \+::testing\+::tuple\texorpdfstring{$<$}{<}T, U\texorpdfstring{$>$}{>}} where {\ttfamily T} and {\ttfamily U} are the element type of the actual container and the expected container, respectively. For example, to compare two {\ttfamily Foo} containers where {\ttfamily Foo} doesn\textquotesingle{}t support {\ttfamily operator==} but has an {\ttfamily Equals()} method, one might write\+:
\end{DoxyItemize}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md47}{}\doxysubsection{Member Matchers}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md47}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily Field(\&class\+::field, m)}   }&\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily argument.\+field} (or {\ttfamily argument-\/\texorpdfstring{$>$}{>}field} when {\ttfamily argument} is a plain pointer) matches matcher {\ttfamily m}, where {\ttfamily argument} is an object of type {\itshape class}.    }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
...
{\ttfamily Property(\&class\+::property, m)}   &{\ttfamily argument.\+property()} (or {\ttfamily argument-\/\texorpdfstring{$>$}{>}property()} when {\ttfamily argument} is a plain pointer) matches matcher {\ttfamily m}, where {\ttfamily argument} is an object of type {\itshape class}.   \\\cline{1-2}
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md48}{}\doxysubsection{Matching the Result of a Function or Functor}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md48}
$\vert${\ttfamily Result\+Of(f, m)}$\vert${\ttfamily f(argument)} matches matcher {\ttfamily m}, where {\ttfamily f} is a function or functor.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md49}{}\doxysubsection{Pointer Matchers}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md49}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md50}{}\doxysubsection{Multiargument Matchers}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md50}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md51}{}\doxysubsection{Composite Matchers}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md51}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md52}{}\doxysubsection{Adapters for Matchers}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md52}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)}   }&\cellcolor{\tableheadbgcolor}\textbf{ casts matcher {\ttfamily m} to type {\ttfamily Matcher\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.    }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)}   }&\cellcolor{\tableheadbgcolor}\textbf{ casts matcher {\ttfamily m} to type {\ttfamily Matcher\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.    }\\\cline{1-2}
\endhead
{\ttfamily Safe\+Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)}   &\href{CookBook.md\#casting-matchers}{\texttt{ safely casts}} matcher {\ttfamily m} to type {\ttfamily Matcher\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.    \\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md53}{}\doxysubsection{Matchers as Predicates}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md53}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md54}{}\doxysubsection{Defining Matchers}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md54}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily MATCHER(Is\+Even, \char`\"{}\char`\"{}) \{ return (arg \% 2) == 0; \}}   }&\cellcolor{\tableheadbgcolor}\textbf{ Defines a matcher {\ttfamily Is\+Even()} to match an even number.    }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily MATCHER(Is\+Even, \char`\"{}\char`\"{}) \{ return (arg \% 2) == 0; \}}   }&\cellcolor{\tableheadbgcolor}\textbf{ Defines a matcher {\ttfamily Is\+Even()} to match an even number.    }\\\cline{1-2}
\endhead
{\ttfamily MATCHER\+\_\+P(Is\+Divisible\+By, n, \char`\"{}\char`\"{}) \{ $\ast$result\+\_\+listener \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<} \char`\"{}where the remainder is \char`\"{} \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<} (arg \% n); return (arg \% n) == 0; \}}   &Defines a macher {\ttfamily Is\+Divisible\+By(n)} to match a number divisible by {\ttfamily n}.    \\\cline{1-2}
{\ttfamily MATCHER\+\_\+\+P2(Is\+Between, a, b, std\+::string(negation ? \char`\"{}isn\textquotesingle{}t\char`\"{} \+: \char`\"{}is\char`\"{}) + \char`\"{} between \char`\"{} + Print\+To\+String(a) + \char`\"{} and \char`\"{} + Print\+To\+String(b)) \{ return a \texorpdfstring{$<$}{<}= arg \&\& arg \texorpdfstring{$<$}{<}= b; \}}   &Defines a matcher {\ttfamily Is\+Between(a, b)} to match a value in the range \mbox{[}{\ttfamily a}, {\ttfamily b}\mbox{]}.   \\\cline{1-2}
\end{longtabu}
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md55}{}\doxysubsection{Matchers as Test Assertions}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md55}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily ASSERT\+\_\+\+THAT(expression, m)}   }&\cellcolor{\tableheadbgcolor}\textbf{ Generates a \href{../../googletest/docs/Primer.md\#assertions}{\texttt{ fatal failure}} if the value of {\ttfamily expression} doesn\textquotesingle{}t match matcher {\ttfamily m}.    }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily ASSERT\+\_\+\+THAT(expression, m)}   }&\cellcolor{\tableheadbgcolor}\textbf{ Generates a \href{../../googletest/docs/Primer.md\#assertions}{\texttt{ fatal failure}} if the value of {\ttfamily expression} doesn\textquotesingle{}t match matcher {\ttfamily m}.    }\\\cline{1-2}
\endhead
{\ttfamily EXPECT\+\_\+\+THAT(expression, m)}   &Generates a non-\/fatal failure if the value of {\ttfamily expression} doesn\textquotesingle{}t match matcher {\ttfamily m}.   \\\cline{1-2}
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md56}{}\doxysection{Actions}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md56}
{\bfseries{Actions}} specify what a mock function should do when invoked.\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md57}{}\doxysubsection{Returning a Value}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md57}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md58}{}\doxysubsection{Side Effects}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md58}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
{\ttfamily Save\+Arg\texorpdfstring{$<$}{<}N\texorpdfstring{$>$}{>}(pointer)}   &Save the {\ttfamily N}-\/th (0-\/based) argument to {\ttfamily $\ast$pointer}.    \\\cline{1-2}
{\ttfamily Save\+Arg\+Pointee\texorpdfstring{$<$}{<}N\texorpdfstring{$>$}{>}(pointer)}   &Save the value pointed to by the {\ttfamily N}-\/th (0-\/based) argument to {\ttfamily $\ast$pointer}.    \\\cline{1-2}
{\ttfamily Set\+Arg\+Referee\texorpdfstring{$<$}{<}N\texorpdfstring{$>$}{>}(value)}   &Assign value to the variable referenced by the {\ttfamily N}-\/th (0-\/based) argument.    \\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md59}{}\doxysubsection{Using a Function or a Functor as an Action}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md59}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
In {\ttfamily Invoke\+Argument\texorpdfstring{$<$}{<}N\texorpdfstring{$>$}{>}(...)}, if an argument needs to be passed by reference, wrap it inside {\ttfamily By\+Ref()}. For example, 
\begin{DoxyCode}{0}
\DoxyCodeLine{InvokeArgument<2>(5, string("{}Hi"{}), ByRef(foo))}

\end{DoxyCode}
 calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md60}{}\doxysubsection{Default Action}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md60}
$\vert${\ttfamily Do\+Default()}$\vert$\+Do the default action (specified by {\ttfamily ON\+\_\+\+CALL()} or the built-\/in one).$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$

{\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md61}{}\doxysubsection{Composite Actions}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md61}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md62}{}\doxysubsection{Defining Actions}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md62}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily ACTION(\+Sum) \{ return arg0 + arg1; \}}   }&\cellcolor{\tableheadbgcolor}\textbf{ Defines an action {\ttfamily Sum()} to return the sum of the mock function\textquotesingle{}s argument \#0 and \#1.    }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
...
The {\ttfamily ACTION$\ast$} macros cannot be used inside a function or class.\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md63}{}\doxysection{Cardinalities}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md63}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md64}{}\doxysection{Expectation Order}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md64}
By default, the expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, there are two ways to specify it. They can be used either independently or together.\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md65}{}\doxysubsection{The After Clause}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md65}
...
Modifying an {\ttfamily Expectation\+Set} after using it in an {\ttfamily .After()} doesn\textquotesingle{}t affect the meaning of the {\ttfamily .After()}.\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md66}{}\doxysubsection{Sequences}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md66}
...
\end{DoxyCode}
 says that all expected calls in the scope of {\ttfamily dummy} must occur in strict order. The name {\ttfamily dummy} is irrelevant.)\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md67}{}\doxysection{Verifying and Resetting a Mock}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md67}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md68}{}\doxysection{Mock Classes}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md68}
...
\end{DoxyCode}
 See this \href{CookBook.md\#using-check-points}{\texttt{ recipe}} for one application of it.\hypertarget{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md69}{}\doxysection{Flags}\label{md_vendor_googletest_googlemock_docs_CheatSheet_autotoc_md69}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
