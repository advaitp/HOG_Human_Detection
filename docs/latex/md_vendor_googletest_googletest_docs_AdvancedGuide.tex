Now that you have read \mbox{\hyperlink{md_vendor_googletest_googletest_docs_Primer}{Primer}} and learned how to write tests using Google Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md688}{}\doxysection{More Assertions}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md688}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md689}{}\doxysubsection{Explicit Success and Failure}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md689}
...
Note\+: you can only use {\ttfamily FAIL()} in functions that return {\ttfamily void}. See the \href{\#assertion-placement}{\texttt{ Assertion Placement section}} for more information.

{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md690}{}\doxysubsection{Exception Assertions}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md690}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md691}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md691}
...
Google Test gives you three different options to solve this problem\+:\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md692}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md692}
...
\begin{DoxyEnumerate}
\item If you see a compiler error \char`\"{}no matching function to call\char`\"{} when using {\ttfamily ASSERT\+\_\+\+PRED$\ast$} or {\ttfamily EXPECT\+\_\+\+PRED$\ast$}, please see \href{FAQ.md\#the-compiler-complains-no-matching-function-to-call-when-i-use-assert_predn-how-do-i-fix-it}{\texttt{ this FAQ}} for how to resolve it.
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
...
{\itshape Availability}\+: Linux, Windows, Mac\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md693}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md693}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+4.\+1.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md694}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md694}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md695}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md695}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md697}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md697}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md698}{}\doxysubsection{Windows HRESULT assertions}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md698}
...
{\itshape Availability}\+: Windows.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md699}{}\doxysubsection{Type Assertions}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md699}
...
{\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md700}{}\doxysubsection{Assertion Placement}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md700}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md702}{}\doxysection{Death Tests}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md702}
...
If you want to test {\ttfamily EXPECT\+\_\+$\ast$()/\+ASSERT\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ Catching Failures}}.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md703}{}\doxysubsection{How to Write a Death Test}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md703}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Cygwin, and Mac (the latter three are supported since v1.\+3.\+0). {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+DEATH\+\_\+\+IF\+\_\+\+SUPPORTED} are new in v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md704}{}\doxysubsection{Regular Expression Syntax}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md704}
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md706}{}\doxysubsection{Death Tests And Threads}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md706}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md707}{}\doxysubsection{Death Test Styles}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md707}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md708}{}\doxysubsection{Caveats}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md708}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md709}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md709}
\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md710}{}\doxysubsection{Adding Traces to Assertions}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md710}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md711}{}\doxysubsection{Propagating Fatal Failures}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md711}
...
{\itshape Availability\+:} Linux, Windows, Mac. Assertions from multiple threads are currently not supported.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md713}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md713}
...
{\itshape Availability\+:} Linux, Windows, Mac. {\ttfamily Has\+Nonfatal\+Failure()} and {\ttfamily Has\+Failure()} are available since version 1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md714}{}\doxysection{Logging Additional Information}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md714}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md715}{}\doxysection{Sharing Resources Between Tests in the Same Test Case}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md715}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md716}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md716}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md717}{}\doxysection{Value Parameterized Tests}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md717}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md718}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md718}
...
{\itshape Availability}\+: Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+2.\+0.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md719}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md719}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily INSTANTIATE\+\_\+\+TEST\+\_\+\+CASE\+\_\+\+P()}, and linking with {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test case multiple times, possibly in different source files.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md720}{}\doxysection{Typed Tests}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md720}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md721}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md721}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md722}{}\doxysection{Testing Private Code}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md722}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md723}{}\doxysubsection{Static Functions}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md723}
...
However, a better approach is to move the private code into the {\ttfamily foo\+::internal} namespace, where {\ttfamily foo} is the namespace your project normally uses, and put the private declarations in a {\ttfamily $\ast$-\/internal.h} file. Your production {\ttfamily .cc} files and your tests are allowed to include this internal header, but your clients are not. This way, you can fully test your internal implementation without leaking it to your clients.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md724}{}\doxysubsection{Private Class Members}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md724}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md725}{}\doxysection{Catching Failures}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md725}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md726}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md726}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md727}{}\doxysection{Extending Google Test by Handling Test Events}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md727}
...
{\itshape Availability\+:} Linux, Windows, Mac; since v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md728}{}\doxysubsection{Defining Event Listeners}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md728}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md729}{}\doxysubsection{Using Event Listeners}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md729}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default XML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md730}{}\doxysubsection{Generating Failures in Listeners}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md730}
...
We have a sample of failure-\/raising listener \href{../samples/sample10_unittest.cc}{\texttt{ here}}.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md731}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md731}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md732}{}\doxysubsection{Selecting Tests}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md732}
This section shows various options for choosing which tests to run.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md733}{}\doxysubsubsection{Listing Test Names}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md733}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md734}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md734}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md735}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md735}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md736}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md736}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md737}{}\doxysubsection{Repeating the Tests}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md737}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md738}{}\doxysubsection{Shuffling the Tests}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md738}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md739}{}\doxysubsection{Controlling Test Output}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md739}
{\itshape  This section teaches how to tweak the way test results are reported.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md740}{}\doxysubsubsection{Colored Terminal Output}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md740}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md741}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md741}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md742}{}\doxysubsubsection{Generating an XML Report}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md742}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md743}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md743}
{\itshape  }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md744}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md744}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md745}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md745}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md746}{}\doxysubsubsection{Letting Another Testing Framework Drive}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md746}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md747}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md747}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md748}{}\doxysection{Fusing Google Test Source Files}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md748}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md749}{}\doxysection{Where to Go from Here}\label{md_vendor_googletest_googletest_docs_AdvancedGuide_autotoc_md749}
{\itshape  Congratulations! You\textquotesingle{}ve now learned more advanced Google Test tools and are ready to tackle more complex testing tasks. If you want to dive even deeper, you can read the \mbox{\hyperlink{md_vendor_googletest_googletest_docs_FAQ}{Frequently-\/\+Asked Questions}}. }