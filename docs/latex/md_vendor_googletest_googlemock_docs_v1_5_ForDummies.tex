({\bfseries{Note\+:}} If you get compiler errors that you don\textquotesingle{}t understand, be sure to consult Google Mock Doctor.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md325}{}\doxysection{What Is Google C++ Mocking Framework?}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md325}
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md326}{}\doxysection{Why Google Mock?}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md326}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md327}{}\doxysection{Getting Started}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md327}
Using Google \mbox{\hyperlink{classMock}{Mock}} is easy! Inside your C++ source file, just {\ttfamily \#include} {\ttfamily \texorpdfstring{$<$}{<}\mbox{\hyperlink{gtest_8h_source}{gtest/gtest.\+h}}\texorpdfstring{$>$}{>}} and {\ttfamily \texorpdfstring{$<$}{<}\mbox{\hyperlink{gmock_8h_source}{gmock/gmock.\+h}}\texorpdfstring{$>$}{>}}, and you are ready to go.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md328}{}\doxysection{A Case for Mock Turtles}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md328}
...
Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using Google \mbox{\hyperlink{classMock}{Mock}}. However, as we shall reveal soon, Google \mbox{\hyperlink{classMock}{Mock}} allows you to do {\itshape much more} with the mocks.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md333}{}\doxysubsection{Using Google Mock with Any Testing Framework}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md333}
...
A better solution is to use Google Test\textquotesingle{}s \href{http://code.google.com/p/googletest/wiki/GoogleTestAdvancedGuide\#Extending_Google_Test_by_Handling_Test_Events}{\texttt{ event listener API}} to report a test failure to your testing framework properly. You\textquotesingle{}ll need to implement the {\ttfamily On\+Test\+Part\+Result()} method of the event listener interface, but it should be straightforward.

If this turns out to be too much work, we suggest that you stick with Google Test, which works with Google \mbox{\hyperlink{classMock}{Mock}} seamlessly (in fact, it is technically part of Google \mbox{\hyperlink{classMock}{Mock}}.). If there is a reason that you cannot use Google Test, please let us know.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md334}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md334}
The key to using a mock object successfully is to set the {\itshape right expectations} on it. If you set the expectations too strict, your test will fail as the result of unrelated changes. If you set them too loose, bugs can slip through. You want to do it just right such that your test can catch exactly the kind of bugs you intend it to catch. Google \mbox{\hyperlink{classMock}{Mock}} provides the necessary means for you to do it \char`\"{}just right.\char`\"{}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md335}{}\doxysubsection{General Syntax}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md335}
...
This checks that the turtle will be told to go forward by at least 100 units.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md337}{}\doxysubsection{Cardinalities\+: How Many Times Will It Be Called?}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md337}
...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! If you are impatient, the details can be found in the Cook\+Book.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md341}{}\doxysubsection{All Expectations Are Sticky (\+Unless Said Otherwise)}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md341}
