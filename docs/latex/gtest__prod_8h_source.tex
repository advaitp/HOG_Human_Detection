...
\label{gtest__prod_8h_source}\index{vendor/googletest/googletest/include/gtest/gtest\_prod.h@{vendor/googletest/googletest/include/gtest/gtest\_prod.h}}
...
\DoxyCodeLine{32 \textcolor{comment}{// Google C++ Testing Framework definitions useful in production code.}}
\DoxyCodeLine{33 }
...
\DoxyCodeLine{43 \textcolor{comment}{//   void MyMethod();}}
\DoxyCodeLine{44 \textcolor{comment}{//   FRIEND\_TEST(MyClassTest, MyMethod);}}
...
\DoxyCodeLine{51 \textcolor{comment}{// TEST\_F(MyClassTest, MyMethod) \{}}
\DoxyCodeLine{52 \textcolor{comment}{//   // Can call MyClass::MyMethod() here.}}
\DoxyCodeLine{53 \textcolor{comment}{// \}}}
\DoxyCodeLine{54 }
\DoxyCodeLine{55 \textcolor{preprocessor}{\#define FRIEND\_TEST(test\_case\_name, test\_name)\(\backslash\)}}
\DoxyCodeLine{56 \textcolor{preprocessor}{friend class test\_case\_name\#\#\_\#\#test\_name\#\#\_Test}}
\DoxyCodeLine{57 }
\DoxyCodeLine{58 \textcolor{preprocessor}{\#endif  }\textcolor{comment}{// GTEST\_INCLUDE\_GTEST\_GTEST\_PROD\_H\_}}
