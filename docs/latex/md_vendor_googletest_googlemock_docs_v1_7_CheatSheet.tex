\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md514}{}\doxysection{Mocking a Normal Class}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md514}
Given 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md515}{}\doxysection{Mocking a Class Template}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md515}
To mock 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md516}{}\doxysection{Specifying Calling Conventions for Mock Functions}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md516}
...
\end{DoxyCode}
 where {\ttfamily STDMETHODCALLTYPE} is defined by {\ttfamily \texorpdfstring{$<$}{<}objbase.\+h\texorpdfstring{$>$}{>}} on Windows.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md517}{}\doxysection{Using Mocks in Tests}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md517}
The typical flow is\+:
\begin{DoxyEnumerate}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md518}{}\doxysection{Setting Default Actions}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md518}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md519}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md519}
...
A method with no {\ttfamily EXPECT\+\_\+\+CALL()} is free to be invoked {\itshape any number of times}, and the default action will be taken each time.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md520}{}\doxysection{Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md520}
...
Built-\/in matchers (where {\ttfamily argument} is the function argument) are divided into several categories\+:\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md521}{}\doxysubsection{Wildcard}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md521}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md522}{}\doxysubsection{Generic Comparison}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md522}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md524}{}\doxysubsection{String Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md524}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} use the regular expression syntax defined \href{http://code.google.com/p/googletest/wiki/AdvancedGuide\#Regular_Expression_Syntax}{\texttt{ here}}. {\ttfamily Str\+Case\+Eq()}, {\ttfamily Str\+Case\+Ne()}, {\ttfamily Str\+Eq()}, and {\ttfamily Str\+Ne()} work for wide strings as well.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md525}{}\doxysubsection{Container Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md525}
...
\item {\ttfamily m} in {\ttfamily Pointwise(m, ...)} should be a matcher for {\ttfamily \mbox{\hyperlink{classstd_1_1tr1_1_1tuple}{std\+::tr1\+::tuple}}\texorpdfstring{$<$}{<}T, U\texorpdfstring{$>$}{>}} where {\ttfamily T} and {\ttfamily U} are the element type of the actual container and the expected container, respectively. For example, to compare two {\ttfamily Foo} containers where {\ttfamily Foo} doesn\textquotesingle{}t support {\ttfamily operator==} but has an {\ttfamily Equals()} method, one might write\+:
\end{DoxyItemize}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md526}{}\doxysubsection{Member Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md526}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md527}{}\doxysubsection{Matching the Result of a Function or Functor}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md527}
$\vert${\ttfamily Result\+Of(f, m)}$\vert${\ttfamily f(argument)} matches matcher {\ttfamily m}, where {\ttfamily f} is a function or functor.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md528}{}\doxysubsection{Pointer Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md528}
$\vert${\ttfamily Pointee(m)}$\vert${\ttfamily argument} (either a smart pointer or a raw pointer) points to a value that matches matcher {\ttfamily m}.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md529}{}\doxysubsection{Multiargument Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md529}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md530}{}\doxysubsection{Composite Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md530}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md531}{}\doxysubsection{Adapters for Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md531}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)}   }&\cellcolor{\tableheadbgcolor}\textbf{ casts matcher {\ttfamily m} to type {\ttfamily Matcher\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.    }\\\cline{1-2}
\endhead
{\ttfamily Safe\+Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)}   &\href{http://code.google.com/p/googlemock/wiki/V1_7_CookBook\#Casting_Matchers}{\texttt{ safely casts}} matcher {\ttfamily m} to type {\ttfamily Matcher\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.    \\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md532}{}\doxysubsection{Matchers as Predicates}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md532}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md533}{}\doxysubsection{Defining Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md533}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md534}{}\doxysubsection{Matchers as Test Assertions}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md534}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily ASSERT\+\_\+\+THAT(expression, m)}   }&\cellcolor{\tableheadbgcolor}\textbf{ Generates a \href{http://code.google.com/p/googletest/wiki/Primer\#Assertions}{\texttt{ fatal failure}} if the value of {\ttfamily expression} doesn\textquotesingle{}t match matcher {\ttfamily m}.    }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md535}{}\doxysection{Actions}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md535}
{\bfseries{Actions}} specify what a mock function should do when invoked.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md536}{}\doxysubsection{Returning a Value}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md536}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md537}{}\doxysubsection{Side Effects}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md537}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md538}{}\doxysubsection{Using a Function or a Functor as an Action}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md538}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyCode}
 calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md539}{}\doxysubsection{Default Action}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md539}
...
{\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md540}{}\doxysubsection{Composite Actions}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md540}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md541}{}\doxysubsection{Defining Actions}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md541}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
The {\ttfamily ACTION$\ast$} macros cannot be used inside a function or class.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md542}{}\doxysection{Cardinalities}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md542}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md543}{}\doxysection{Expectation Order}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md543}
By default, the expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, there are two ways to specify it. They can be used either independently or together.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md544}{}\doxysubsection{The After Clause}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md544}
...
Modifying an {\ttfamily Expectation\+Set} after using it in an {\ttfamily .After()} doesn\textquotesingle{}t affect the meaning of the {\ttfamily .After()}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md545}{}\doxysubsection{Sequences}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md545}
...
\end{DoxyCode}
 says that all expected calls in the scope of {\ttfamily dummy} must occur in strict order. The name {\ttfamily dummy} is irrelevant.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md546}{}\doxysection{Verifying and Resetting a Mock}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md546}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md547}{}\doxysection{Mock Classes}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md547}
...
\end{DoxyCode}
 See this \href{http://code.google.com/p/googlemock/wiki/V1_7_CookBook\#Using_Check_Points}{\texttt{ recipe}} for one application of it.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md548}{}\doxysection{Flags}\label{md_vendor_googletest_googlemock_docs_v1_7_CheatSheet_autotoc_md548}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
